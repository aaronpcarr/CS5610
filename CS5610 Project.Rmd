...
The quandradic discriminant model has an accuracy of only around 85%, close to the other models but slightly weaker. This might be an indication that the boundary between categories can be represented linearly. 
...
```
The Naive Bayes model performs about as well as the quadradic discriminant model, at around 84%. 
